...
import com.epam.nuralin.yeldar.write_service.dto.ErrorDto;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    public ErrorDto handleHttpMessageNotReadableException(MethodArgumentNotValidException e) {
        Map<String, String> errorMap = new HashMap<>();
    ...
    @ResponseBody
    public ErrorDto handleConflictException(AlreadyExistException e) {
        return new ErrorDto(e.getMessage(), null, "409");
    }
}
